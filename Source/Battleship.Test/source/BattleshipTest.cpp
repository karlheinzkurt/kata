#include "Battleship.Lib/include/Battleship.h"
...
{   
   auto game(Battleship::CGame::CBuilder()
      ...
      .placeShip(Battleship::IShip::Type::Destroyer, Battleship::CCoordinate("B", 2), Battleship::CCoordinate("B", 6))
      .placeShip(Battleship::IShip::Type::Cruiser, Battleship::CCoordinate("C", 7), Battleship::CCoordinate("E", 7))
      .placeShip(Battleship::IShip::Type::Cruiser, Battleship::CCoordinate("I", 3), Battleship::CCoordinate("G", 3))
      .create());
